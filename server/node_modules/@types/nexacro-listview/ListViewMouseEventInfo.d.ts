...
interface NexacroAPI {
    ListViewMouseEventInfo: nexacro.ListViewMouseEventInfo;
}

    
declare namespace nexacro {
    
	interface ListViewMouseEventInfo extends nexacro.EventInfo {
	    /**
		 * @constructor
		 */
		new(): nexacro.ListViewMouseEventInfo;
	    /**
		 * This property holds a value indicating whether an event occurred with the Alt key pressed.
		 */
		readonly altkey?: any;
		/**
		 * This read-only property holds the information on a band that triggered an event.
		 */
		readonly bandid?: any;
		/**
		...
		/**
		 * This read-only property holds the ID of a cell that triggered an event.
		 */
		readonly cellid?: any;
		/**
		...
		/**
		 * This read-only property holds the row index number of an item that triggered an event.
		 */
		readonly row?: any;
		/**
