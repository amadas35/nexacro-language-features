...
interface NexacroAPI {
    FileUploadMouseEventInfo: nexacro.FileUploadMouseEventInfo;
}

    
declare namespace nexacro {
    
	interface FileUploadMouseEventInfo extends nexacro.EventInfo {
	    /**
		 * @constructor
		 */
		new(): nexacro.FileUploadMouseEventInfo;
	    /**
		...
		/**
		 * This property holds the index of a FileUploadItem control that has fired an event.
		 */
