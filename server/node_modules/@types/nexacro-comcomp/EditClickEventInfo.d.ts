...
interface NexacroAPI {
    EditClickEventInfo: nexacro.EditClickEventInfo;
}

    
declare namespace nexacro {
    
	interface EditClickEventInfo extends nexacro.EventInfo {
	    /**
		 * @constructor
		 */
		new(): nexacro.EditClickEventInfo;
	    /**
		...
		/**
		 * This property holds the index number of the position in a component where the caret was placed when the event occurred.
		 */
