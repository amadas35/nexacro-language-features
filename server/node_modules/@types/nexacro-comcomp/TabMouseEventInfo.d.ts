...
interface NexacroAPI {
    TabMouseEventInfo: nexacro.TabMouseEventInfo;
}

    
declare namespace nexacro {
    
	interface TabMouseEventInfo extends nexacro.EventInfo {
	    /**
		 * @constructor
		 */
		new(): nexacro.TabMouseEventInfo;
	    /**
		...
		/**
		 * This property holds the index number of a tab button where the extrabutton control is clicked.
		 */
