...
interface NexacroAPI {
    MenuContextMenuEventInfo: nexacro.MenuContextMenuEventInfo;
}

    
declare namespace nexacro {
    
	interface MenuContextMenuEventInfo extends nexacro.EventInfo {
	    /**
		 * @constructor
		 */
		new(): nexacro.MenuContextMenuEventInfo;
	    /**
