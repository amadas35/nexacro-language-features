...
interface NexacroAPI {
    FileUploadContextMenuEventInfo: nexacro.FileUploadContextMenuEventInfo;
}

    
declare namespace nexacro {
    
	interface FileUploadContextMenuEventInfo extends nexacro.EventInfo {
	    /**
		 * @constructor
		 */
		new(): nexacro.FileUploadContextMenuEventInfo;
	    /**
